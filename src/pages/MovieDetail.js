                                                    ...
                                                    return <div key={cumRap.maCumRap}>
                                                        ...
                                                        <div className="row"
                                                            ...
                                                            {cumRap.lichChieuPhim?.slice(0, 12).map((lichChieu, index) => {
                                                                ...
                                                                return <NavLink style={{color:"red"}} className="col-2" key={lichChieu.maLichChieu} to={`/showtime/${lichChieu.maLichChieu}`}>{moment(lichChieu.ngayChieuGioChieu).format('hh:mm A')}</NavLink>
                                                            })}
                                                        </div>
                                                    </div>
                                                })}
